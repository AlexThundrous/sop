      ...
      <main>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm justify-center items-center my-auto">
          <form className="space-y-6" action="http://localhost:3000" method="get">
            <button
              type="submit"
              className="flex items-center justify-center px-4 py-2 mb-12 w-full text-white bg-blue-500 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-md"
            >
